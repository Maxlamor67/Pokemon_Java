...
//                "Scorplane", "Cizayox", "Yveltal", "Mewtwo","Giratina"));
       this.nomsPokemon = new ArrayList<>(Arrays.asList("He", "Flo", "Sal", "Dra", "Bul", "Pi",
               ...
               "Psy", "Ti", "Démo", "Ping", "Ryx", "Mana",
                "Sco", "Ciz", "Yve", "Mew", "Gir"));
        pouvoirs = new ArrayList<>(Arrays.asList(new SoinSimple(), new SoinTotal(), new Resistance(), new SoinTotal(), new Resistance(), new SoinTotal(), new Resistance(), new SoinTotal(), new Resistance(), new SoinTotal(), new Resistance(), new SoinTotal(), new Resistance()));
